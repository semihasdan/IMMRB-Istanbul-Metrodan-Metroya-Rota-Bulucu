...
interface RouteFormProps {
  onRouteFound: (route: MapRoute) => void;
  onStartStationChange: (station: MapStation | null) => void;
  onEndStationChange: (station: MapStation | null) => void;
}

interface GroupedStations {
  [key: string]: MapStation[];
}
